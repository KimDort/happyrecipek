...
organizer.setOnClickListener('days-blocks', function () { showEvents();}, null);
organizer.setOnClickListener('month-slider', function () { showEvents();}, function () { showEvents();});
organizer.setOnClickListener('year-slider', function () { showEvents();}, function () { showEvents();});