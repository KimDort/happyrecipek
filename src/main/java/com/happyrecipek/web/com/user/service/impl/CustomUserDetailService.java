package com.happyrecipek.web.com.user.service.impl;
...
public class CustomUserDetailService implements UserDetailsService{
	...
	private static Collection<? extends GrantedAuthority> getAuthorities(Member member){
		String[] memberRoles = member.getRoles().stream().map((AuthorityRole) -> AuthorityRole.getAuthority_role_code()).toArray(String[]::new);
